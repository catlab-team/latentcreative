...
parser.add_argument('--transformer', default=["OneDirectionZ", "None"], nargs=2, type=str, metavar=["name", "arguments"], help="transformer function")
...
#optimizer = RAdam(transformation.parameters(), lr=0.01)
#optimizer = RAdam(transformation.parameters(), lr=0.001)
